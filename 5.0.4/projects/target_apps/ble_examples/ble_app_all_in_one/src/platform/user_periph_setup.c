...
void GPIO_reservations(void)
{
    ...
    RESERVE_GPIO(A10,GPIO_BUTTON_CALI_PORT, GPIO_BUTTON_CALI_PIN, PID_GPIO);    
}
...
//  GPIO_SetActive(GPIO_POWER_PORT, GPIO_POWER_PIN);//power on
    ...
    GPIO_ConfigurePin(GPIO_BUTTON_CALI_PORT, GPIO_BUTTON_CALI_PIN, INPUT_PULLUP, PID_GPIO, false);
